...
def _rebuild_timelapse(cfg: Config, date_str: str) -> None:
    ...
    try:
        build_timelapse(snapshots, output, fps=cfg.timelapse_fps, stabilize=cfg.timelapse_stabilize, subtitles=cfg.timelapse_subtitles, subtitle_every=cfg.timelapse_subtitle_every)
