...
def build_permanent(cfg: Config, now: datetime | None = None) -> Path:
    ...
    build_timelapse(all_snapshots, output, fps=cfg.timelapse_fps, stabilize=cfg.timelapse_stabilize, stabilize_crop=cfg.timelapse_stabilize_crop, subtitles=cfg.timelapse_subtitles, subtitle_every=cfg.timelapse_subtitle_every, burnin=cfg.timelapse_burnin, burnin_every_minutes=cfg.timelapse_burnin_every)
    return output
